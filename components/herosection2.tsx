    ...
    <div className="w-full max-w-[1200px] mx-auto h-[20%] px-4 gap-6 flex flex-row sm:px-0 sm:py-16 ">
      <div className="flex flex-row w-full h-48 sm:h-[100%]  justify-between gap- pt-4 sm:py-4 sm:gap-6">
        <div className="flex flex-col w-full h-50 aos-init aos-animate">
          ...
          <br />
          <br />
          <p className="text-xl text-green-500 font-bold">"Faire du Numérique <br />
          congolais un lévier <br />
          d'intégration,
          <br />
          ...
          <br />
          <h6>
            Son excellence Monsieur <br />
            Félix Antoine Tshisekedi Tshilombo, <br />
            Président de la république <br />
            Démocratique du congo Kinshasa <br />
            dans son discours du 3 septembre 2019
          </h6>
        </div>
      </div>
      <div
